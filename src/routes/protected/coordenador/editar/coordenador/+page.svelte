<script lang="ts">
  ...
  <svelte:head>
    <title>Coordenador | Alterar Coordenador</title>
  </svelte:head>
  ...
  <main>
    ...
    <div class="flex items-center justify-center">
      <ul class="w-1/2">
        {#each professores as professor}
          {#if professor.enabled && professor.nome != username}
    ...
    <dialog bind:this={modal} class="modal">
      <div class="modal-box">
        ...
        <p class="py-4">
          Você tem certeza que deseja tornar <br /><span
